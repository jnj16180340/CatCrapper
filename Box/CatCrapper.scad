...
//--      (6.2 + 4.5) - (3.5 + 1.5) ==> 5.7
baseWallHeight    = 30;//6.2;
lidWallHeight     = 10;//5.0;
...
standoffHeight    = 3.5;
standoffPinDiameter = 1.7;  // M2 screw
standoffDiameter  = 5.2;

/*
outer: 52 x 88 ish
hole2hole: 35 x 78 (+ 4mm, 7mm to edge)
2mm hole diamater
LEDs each 10mm diameter
about 25mm overhand / xbee at top edge
...
// NB: Using stands as the PCB diameter because they're easier to measure.
/*
pcbLength         = 78;
pcbWidth          = 35;
*/
pcbStands = [
                 [0,  0, 10,4,8, yappBaseOnly, yappHole]         // back-left
               , [0, pcbWidth, 10,4,8, yappBaseOnly, yappHole] // back-right
               , [pcbLength,  0, 10,4,8, yappBaseOnly, yappHole]       // front-left
               , [pcbLength, pcbWidth, 10,4,8, yappBaseOnly, yappHole]      // front-right
             ];
